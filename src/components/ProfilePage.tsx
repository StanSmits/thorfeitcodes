          ...
          <div className="border-b border-gray-200 px-6 py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <span
                  className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mt-1 ${getRoleBadgeColor(
                    user.role
                  )}`}
                >
          ...
          <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Input
                    ...
                    value={
                      isEditing ? profileForm.full_name : user.full_name || ""
                    }
                    onChange={(e) =>
                      setProfileForm({
                        ...profileForm,
                        ...
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-sm text-gray-600">
                              per {plan.interval === "month" ? "maand" : "jaar"}
                            </p>
                          </div>
                        </div>
            ...
            {activeTab === "security" && (
              <div className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 opacity-90 hover:opacity-100 transition group cursor-not-allowed">
                  <h3 className="text-md font-semibold text-gray-800 mb-4">
                    Wachtwoord wijzigen
                  </h3>

                  <div className="space-y-4 pointer-events-none group-hover:bg-gray-50">
                    <div className="relative">
                      <Input
                        ...
                        disabled
                      />
                      <div className="absolute right-3 top-9 text-gray-300">
          ...
          <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
              ...
              <p className="text-gray-600 mb-6">
                Weet je zeker dat je je abonnement wilt opzeggen? Je verliest
                toegang tot alle pro functies.
              </p>
              <div className="flex justify-end space-x-3">
                ...
                <Button onClick={handleCancelSubscription} isLoading={isSaving}>
                  Ja, opzeggen
                </Button>
              </div>
            </div>
